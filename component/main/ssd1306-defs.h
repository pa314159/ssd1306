...
// arguments for OLED_CMD2(SET_MEMORY_ADDR_MODE, mode)
#define OLED_HORI_ADDR_MODE             0x00    /* Horizontal Addressing Mode */
#define OLED_VERT_ADDR_MODE             0x01    /* Vertical Addressing Mode */
#define OLED_PAGE_ADDR_MODE             0x02    /* Page Addressing Mode */
...
#define OLED_CMD_SET_PAGE_ADDRESS       0xB0    /* can be used only in PAGE mode - OR with page number */
...
#define OLED_CMD0(cmd)               (OLED_CMD_##cmd)
#define OLED_CMD1(cmd, arg)          (OLED_CMD_##cmd) | (arg)
#define OLED_CMD2(cmd, arg)          (OLED_CMD_##cmd), (arg)
#define OLED_CMD3(cmd, arg1, arg2)   (OLED_CMD_##cmd), (arg1), (arg2)

#define OLED_CMDL(cmd, arg)          OLED_CMD1(cmd, (arg) & 0x0F)
#define OLED_CMDH(cmd, arg)          OLED_CMD1(cmd, ((arg) >> 4) & 0x0F)

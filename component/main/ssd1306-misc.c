...
void ssd1306_fill_randomly(ssd1306_t device, const ssd1306_bounds_t* bounds)
{
	...
	const ssd1306_size_t size = {
		w: ssd1306_bounds_width(bounds),
		h: ssd1306_bounds_height(bounds),
	};
	...
	ssd1306_bitmap_t* bitmap = ssd1306_create_bitmap(ssd1306_bounds_width(&trimmed), ssd1306_bounds_height(&trimmed));
